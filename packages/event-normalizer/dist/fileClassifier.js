...
function toProjectRelativePath(filePath, rootPath) {
    const relative = node_path_1.default.isAbsolute(filePath) ? node_path_1.default.relative(rootPath, filePath) : filePath;
    ...
    if (normalized.startsWith('..')) {
        ...
        return `(outside-project)/${node_path_1.default.basename(filePath)}`;
    }
    return normalized;
}
/**
 ...
 */
function classifyFile(filePath, rootPath) {
